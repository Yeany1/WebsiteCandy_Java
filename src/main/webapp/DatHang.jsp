    ...
    <body>
        ...
        <div id="logreg-forms">
            <form class="form-signin" action="order" method="post">
                ...
                <label for="Địa Chỉ Giao Hàng">Delivery Address</label>
                <input name="deliveryAddress" type="text" id="deliveryAddress" class="form-control" placeholder="Nhập địa chỉ nhận hàng" required="" autofocus="">
