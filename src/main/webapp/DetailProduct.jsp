  ...
  <main>
    <div class="container">
          ...
          <div class="col-md-6">
            ...
            <div class="table-responsive">
              <table class="table table-sm table-borderless mb-0">
                <tbody>
                 	<tr>
                    <th class="pl-0 w-25" scope="row"><strong>Phân Loại: </strong></th>
                    <td>${detail.model }</td>
                  </tr> 
                  <tr>
                    <th class="pl-0 w-25" scope="row"><strong>Gửi Từ: </strong></th>
                    <td>${detail.color }</td>
                  </tr>
                  <tr>
                    <th class="pl-0 w-25" scope="row"><strong>Vận Chuyển Bởi: </strong></th>
        ...
        <div class="tab-content" id="advancedTabContent">
          ...
          <div class="tab-pane fade" id="info" role="tabpanel" aria-labelledby="info-tab">
            ...
            <table class="table table-striped table-bordered mt-3">
              <thead>
                <tr>
                  <th scope="row" class="w-150 dark-grey-text h6">Nặng</th>
                  <td><em>g</em></td>
                </tr>
              </thead>
              <tbody>
          ...
          <div class="tab-pane fade" id="reviews" role="tabpanel" aria-labelledby="reviews-tab">
            <h5><span>${countAllReview }</span> bình luận cho <span>${detail.name }</span></h5>
      ...
      <section class="text-center">
        ...
        <h4 class="text-center my-5"><strong>Những sảm phẩm tương tự</strong></h4>
