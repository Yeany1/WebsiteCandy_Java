    ...
    <body onload="loadTotalMoney()">
				  	...
				  	${mess}
                                                ...
                                                <tr>
                                                    ...
                                                    <th scope="col" class="border-0 bg-light">
                                                     ...
                                                     <th scope="col" class="border-0 bg-light">
                                                        <div class="py-2 text-uppercase">Gửi Từ</div>
                                                    </th>
                                                     <th scope="col" class="border-0 bg-light">
                            ...
                            <div class="col-lg-6">
                                ...
                                <div class="p-4">
                                    <ul class="list-unstyled mb-4" id="contentTotalMoney">
                                       <!--  <li class="d-flex justify-content-between py-3 border-bottom"><strong class="text-muted">Tong Tien Hang</strong><strong>100 $</strong></li>
                                        <li class="d-flex justify-content-between py-3 border-bottom"><strong class="text-muted">Phi Van Chuyen</strong><strong>Free ship</strong></li>
                                        <li class="d-flex justify-content-between py-3 border-bottom"><strong class="text-muted">VAT</strong><strong>10 $</strong></li>
                                        <li class="d-flex justify-content-between py-3 border-bottom"><strong class="text-muted">Tong Thanh Toan</strong>
        ...
        <script>
                        function loadTotalMoney(){
                        	 $.ajax({
                                 url: "/WebsiteCandy/totalMoneyCart",
