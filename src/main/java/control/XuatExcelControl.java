...
public class XuatExcelControl extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        FileOutputStream file=new FileOutputStream("D:\\20051981_NgoDinhBaoYen_BTL\\"+ngayXuat+"hoadon.xlsx");
        ...
        cell0.setCellValue("MÃ£ HÃ³a Ä�Æ¡n");
        cell1=row.createCell(1);
        cell1.setCellValue("Account");
        cell2=row.createCell(2);
        cell2.setCellValue("Tá»•ng GiÃ¡($)");
        cell3=row.createCell(3);
        cell3.setCellValue("NgÃ y Xuáº¥t");
        ...
        request.setAttribute("mess", "Xuất file Excel thành công!");
