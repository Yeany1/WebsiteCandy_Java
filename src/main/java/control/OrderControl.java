		...
		try {
			...
			String deliveryAddress = request.getParameter("deliveryAddress");
			 ...
			 HttpSession session = request.getSession();
				...
				email.setFrom("dinhbaoyen2002@gmail.com");
				email.setFromPassword("#ngoyen#@86856yY");
				email.setTo(emailAddress);
				email.setSubject("Dat hang thanh cong tu Yeany Candy");
				StringBuilder sb = new StringBuilder();
				sb.append("Dear ").append(name).append("<br>");
				sb.append("Ban vua dat dang tu Yeany Candy. <br> ");
				...
				sb.append("Cam on ban da dat hang tai Yeany Candy<br>");
